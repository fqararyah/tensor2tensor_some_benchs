...
class NeuralStackModel(t2t_model.T2TModel):
  ...
  def cell(self, model_d):
    ...
    Args:
      model_d: The hidden size of the cell.

    Returns:
      A new RNNCell with the given hidden size.
    """
    return NeuralStackCell(model_d,
...
class NeuralQueueModel(NeuralStackModel):
  ...
  def cell(self, model_d):
    ...
    """
    return NeuralQueueCell(model_d,
                           self._hparams.memory_size,
                           self._hparams.embedding_size)
...
class NeuralDequeModel(NeuralStackModel):
  ...
  def cell(self, model_d):
    ...
    """
    return NeuralDequeCell(model_d,
                           self._hparams.memory_size,
                           self._hparams.embedding_size)
...
def neural_stack():
  ...
  hparams.model_d = hparams.embedding_size
  return hparams
