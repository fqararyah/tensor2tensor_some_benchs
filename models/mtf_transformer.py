...
def mtf_transformer_base(num_encoder_layers = 12, num_decoder_layers = 12):
  ...
  hparams.add_hparam("encoder_layers", ["att", "drd"] * num_encoder_layers)
  hparams.add_hparam("decoder_layers", ["att", "enc_att", "drd"] * num_decoder_layers)
...
def mtf_transformer_tiny():
  """Catch bugs locally..."""
  hparams = mtf_transformer_base()
  hparams.d_model = 2048
  hparams.d_ff = 5120
  hparams.encoder_layers = ["att", "drd"] * 12
  hparams.decoder_layers = ["att", "enc_att", "drd"] * 12
  hparams.num_heads = 8
  hparams.mesh_shape = ""
...
@registry.register_hparams
def mtf_transformer_24_2048_5120_model_2():
  """Catch bugs locally..."""
  num_encoder_layers = 24
  num_decoder_layers = 24
  hparams = mtf_transformer_base(num_encoder_layers, num_decoder_layers)
  hparams.d_model = 2048
  hparams.d_ff = 5120
  
  hparams.num_heads = 16
  hparams.mesh_shape = "model:2"
  hparams.activation_dtype = "float32"
  return hparams

@registry.register_hparams
def mtf_transformer_24_2048_5120_batch_2():
  """Catch bugs locally..."""
  num_encoder_layers = 24
  num_decoder_layers = 24
  hparams = mtf_transformer_base(num_encoder_layers, num_decoder_layers)
...
@registry.register_hparams
def mtf_transformer_24_2048_5120_model_4():
  """Catch bugs locally..."""
  num_encoder_layers = 24
  num_decoder_layers = 24
  hparams = mtf_transformer_base(num_encoder_layers, num_decoder_layers)
...
@registry.register_hparams
def mtf_transformer_24_2048_5120_batch_4():
  """Catch bugs locally..."""
  num_encoder_layers = 24
  num_decoder_layers = 24
  hparams = mtf_transformer_base(num_encoder_layers, num_decoder_layers)
  ...
  hparams.num_heads = 16
  hparams.mesh_shape = "batch:4"
  hparams.activation_dtype = "float32"
  return hparams

@registry.register_hparams
def mtf_transformer_24_2048_5120_model_2_batch_2():
  """Catch bugs locally..."""
  num_encoder_layers = 24
  num_decoder_layers = 24
  hparams = mtf_transformer_base(num_encoder_layers, num_decoder_layers)
  ...
  hparams.num_heads = 16
  hparams.mesh_shape = "model:2;batch:2"
  hparams.activation_dtype = "float32"
  return hparams

@registry.register_hparams
def mtf_transformer_24_2048_5120_batch_8():
  """Catch bugs locally..."""
  num_encoder_layers = 24
  num_decoder_layers = 24
  hparams = mtf_transformer_base(num_encoder_layers, num_decoder_layers)
...
@registry.register_hparams
def mtf_transformer_24_2048_5120_model_8():
  """Catch bugs locally..."""
  num_encoder_layers = 24
  num_decoder_layers = 24
  hparams = mtf_transformer_base(num_encoder_layers, num_decoder_layers)
...
@registry.register_hparams
def mtf_transformer_24_2048_5120_model_2_batch_4():
  """Catch bugs locally..."""
  num_encoder_layers = 24
  num_decoder_layers = 24
  hparams = mtf_transformer_base(num_encoder_layers, num_decoder_layers)
  ...
  hparams.num_heads = 16
  hparams.mesh_shape = "model:2;batch:4"
  hparams.activation_dtype = "float32"
  return hparams

@registry.register_hparams
def mtf_transformer_24_2048_5120_model_4_batch_2():
  """Catch bugs locally..."""
  num_encoder_layers = 24
  num_decoder_layers = 24
  hparams = mtf_transformer_base(num_encoder_layers, num_decoder_layers)
  ...
  hparams.num_heads = 16
  hparams.mesh_shape = "model:4;batch:2"
  hparams.activation_dtype = "float32"
  return hparams

@registry.register_hparams
def mtf_transformer_52_2048_4096_model_2():
  """Catch bugs locally..."""
  num_encoder_layers = 52
  num_decoder_layers = 52
  hparams = mtf_transformer_base(num_encoder_layers, num_decoder_layers)
  hparams.d_model = 2048
  hparams.d_ff = 4096
...
@registry.register_hparams
def mtf_transformer_52_2048_4096_batch_2():
  """Catch bugs locally..."""
  num_encoder_layers = 52
  num_decoder_layers = 52
  hparams = mtf_transformer_base(num_encoder_layers, num_decoder_layers)
...
@registry.register_hparams
def mtf_transformer_52_2048_4096_model_4():
  """Catch bugs locally..."""
  num_encoder_layers = 52
  num_decoder_layers = 52
  hparams = mtf_transformer_base(num_encoder_layers, num_decoder_layers)
...
@registry.register_hparams
def mtf_transformer_52_2048_4096_batch_4():
  """Catch bugs locally..."""
  num_encoder_layers = 52
  num_decoder_layers = 52
  hparams = mtf_transformer_base(num_encoder_layers, num_decoder_layers)
...
@registry.register_hparams
def mtf_transformer_52_2048_4096_model_8():
  """Catch bugs locally..."""
  num_encoder_layers = 52
  num_decoder_layers = 52
  hparams = mtf_transformer_base(num_encoder_layers, num_decoder_layers)
...
@registry.register_hparams
def mtf_transformer_52_2048_4096_model_2_batch_2():
  """Catch bugs locally..."""
  num_encoder_layers = 52
  num_decoder_layers = 52
  hparams = mtf_transformer_base(num_encoder_layers, num_decoder_layers)
...
@registry.register_hparams
def mtf_transformer_52_2048_4096_model_2_batch_4():
  """Catch bugs locally..."""
  num_encoder_layers = 52
  num_decoder_layers = 52
  hparams = mtf_transformer_base(num_encoder_layers, num_decoder_layers)
...
@registry.register_hparams
def mtf_transformer_52_2048_4096_model_4_batch_2():
  """Catch bugs locally..."""
  num_encoder_layers = 52
  num_decoder_layers = 52
  hparams = mtf_transformer_base(num_encoder_layers, num_decoder_layers)
...
@registry.register_hparams
def mtf_transformer_trn2_8():
  """Catch bugs locally..."""
  hparams = mtf_transformer_tiny()
  hparams.d_model = 2048
  hparams.d_ff = 8192
  #hparams.batch_size = 8
  hparams.encoder_layers = ["att", "drd"] * 48
  hparams.decoder_layers = ["att", "enc_att", "drd"] * 48
  hparams.num_heads = 8
  hparams.mesh_shape = ""
  return hparams

@registry.register_hparams
def mtf_transformer_tiny_4_8():
  hparams = mtf_transformer_tiny()
  hparams.mesh_shape = "model:2;batch:4"
  return hparams

@registry.register_hparams
def mtf_transformer_tiny_placer():
  hparams = mtf_transformer_tiny()
  hparams.mesh_shape = ""
  return hparams

@registry.register_hparams
def mtf_transformer_tiny_2_2():
  hparams = mtf_transformer_tiny()
  hparams.mesh_shape = "model:2;batch:2"
  return hparams

@registry.register_hparams
def mtf_transformer_tiny_4_1():
  hparams = mtf_transformer_tiny()
  hparams.mesh_shape = "model:4;batch:1"
  return hparams

@registry.register_hparams
def mtf_transformer_tiny_1_4():
  hparams = mtf_transformer_tiny()
  hparams.mesh_shape = "model:1;batch:4"
  return hparams

@registry.register_hparams
def mtf_transformer_tiny_2_8():
  hparams = mtf_transformer_tiny()
  hparams.mesh_shape = "model:2;batch:8"
  return hparams

@registry.register_hparams
def mtf_transformer_tiny_8_2():
  hparams = mtf_transformer_tiny()
  hparams.mesh_shape = "model:8;batch:2"
  return hparams

@registry.register_hparams
def mtf_transformer_tiny_4_4():
  hparams = mtf_transformer_tiny()
  hparams.mesh_shape = "model:4;batch:4"
  return hparams

@registry.register_hparams
def mtf_transformer_tiny_2_4():
  hparams = mtf_transformer_tiny()
  hparams.mesh_shape = "model:2;batch:4"
  return hparams

@registry.register_hparams
def mtf_transformer_tiny_4_2():
  hparams = mtf_transformer_tiny()
  hparams.mesh_shape = "model:4;batch:2"
  return hparams

@registry.register_hparams
def mtf_transformer_tiny_8_1():
  hparams = mtf_transformer_tiny()
  hparams.mesh_shape = "model:8"
  return hparams

@registry.register_hparams
def mtf_transformer_tiny_1_8():
  hparams = mtf_transformer_tiny()
  hparams.mesh_shape = "batch:8"
  return hparams

@registry.register_hparams
def mtf_transformer_tiny_16_16():
  hparams = mtf_transformer_tiny()
  hparams.mesh_shape = "model:16;batch:16"
  return hparams
