...
def image_transformer_base():
  ...
  hparams.add_hparam("d_ff", 512)  # Add new ones like this.
...
def imagetransformer_base_10l_16h_big_dr01_moe_imgnet():
  ...
  hparams.moe_model_ds = "4096"  # Hidden layer sizes (comma-separated).
...
def imagetransformer_moe_tiny():
  ...
  hparams.moe_model_ds = "1024"  # Hidden layer sizes (comma-separated).
...
def imagetransformer_cifar_tpu_range(rhp):
  ...
  rhp.set_discrete("model_d", [256, 512, 1024])
