...
def get_standardized_layers(hparams, dp=None):
  ...
  conv_hidden_relu = register_layer(
      ...
      default_kwargs=dict(
          model_d=hparams.d_ff,
          output_size=hparams.model_d,
...
def add_standard_attention_hparams(hparams):
  ...
  # To be more consistent, should use d_ff to also control the MOE
  # size if moe_model_ds not set.
