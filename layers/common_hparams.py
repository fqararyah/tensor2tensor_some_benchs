...
def basic_params1():
  ...
  return hparam.HParams(
      ...
      # e.g. "constant*linear_warmup*rsqrt_decay*rsqrt_model_d"
      ...
      moe_model_ds="2048",  # hidden layer sizes (comma-separated)
...
def basic_range1(ranged_hparams):
  ...
  rhp.set_discrete("model_d", [32, 64, 128, 256, 512], scale=rhp.LOG_SCALE)
