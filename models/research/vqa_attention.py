      ...
      with tf.variable_scope("layer_%d" % layer):
        with tf.variable_scope("self_attention"):
          y = vqa_layers.multihead_attention(
              ...
              None,
              None,
              hparams.attention_key_channels or hparams.image_model_d,
              hparams.attention_value_channels or hparams.image_model_d,
              hparams.image_model_d,
              hparams.num_heads,
