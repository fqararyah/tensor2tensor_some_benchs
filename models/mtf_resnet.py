...
class MtfResNet(mtf_model.MtfModel):
  ...
  def mtf_model_fn(self, features, mesh):
    ...
    hidden_dim = mtf.Dimension("hidden", hparams.model_d)
    filter_dim = mtf.Dimension("filters", hparams.d_ffs[0])
...
def mtf_resnet_base():
  ...
  hparams.add_hparam("d_ffs", [64, 64, 128, 256, 512])
